function [nn,inits,transitions]= trainSAEHMMBillboard7Inv_earlystop(ffts_train,gts_train,gts_full,layer1,layer2,layer3,layer4,layer5,layer6, multi_res, pcp_pretrain,varargin)
...
if (multi_res == 1)
    if (pcp_pretrain == 1)
        nn = constructAEPCP(ffts_train,gts_train,layer1,layer2,layer3,layer4,layer5,layer6,num_batch,num_train_unsup,num_train_pcp,num_train_chord,4500,sparsity,dropout,zeroMaskFrac,sparsityPenalty,L2weightPenalty);
    else
        nn = constructAE(ffts_train,gts_train,layer1,layer2,layer3,layer4,layer5,layer6,num_batch,num_train_unsup,num_train_pcp,num_train_chord,4500,sparsity,dropout,zeroMaskFrac,sparsityPenalty,L2weightPenalty);%constructAE(ffts_train,gts_train,200,0); %constructAE(ffts_train,gts_train,200,0);
    end
else
    if (pcp_pretrain == 1)
        nn = constructAEPCP(ffts_train,gts_train,layer1,layer2,layer3,layer4,layer5,layer6,num_batch,num_train_unsup,num_train_pcp,num_train_chord,1500,sparsity,dropout,zeroMaskFrac,sparsityPenalty,L2weightPenalty);
    else
        nn = constructAE(ffts_train,gts_train,layer1,layer2,layer3,layer4,layer5,layer6,num_batch,num_train_unsup,num_train_pcp,num_train_chord,1500,sparsity,dropout,zeroMaskFrac,sparsityPenalty,L2weightPenalty);
    end
end
...
function [nn] = constructAE(train_x,train_y,layer1,layer2,layer3,layer4,layer5,layer6,num_batch,num_train_unsup,num_train_pcp,num_train_chord,num_inputs,sparsity,dropout,zeroMaskFrac,sparsityPenalty,L2weightPenalty)
...
%train sae
    ...
    %back prop
    nn = nnsetup([num_inputs layer1 217]);
...
if(layer1 > 0 && layer2 > 0 && layer3 > 0 && layer4 == 0)
    ...
    % back prop
    nn = nnsetup([num_inputs layer1 layer2 layer3 217]);
...
if(layer1 > 0 && layer2 > 0 && layer3 > 0 && layer4 > 0 && layer5 == 0)
    ...
    % back prop
    nn = nnsetup([num_inputs layer1 layer2 layer3 layer4 217]);
...
if(layer1 > 0 && layer2 > 0 && layer3 > 0 && layer4 > 0 && layer5 > 0 && layer6 == 0)
    ...
    % back prop
    nn = nnsetup([num_inputs layer1 layer2 layer3 layer4 layer5 217]);
...
if(layer1 > 0 && layer2 > 0 && layer3 > 0 && layer4 > 0 && layer5 > 0 && layer6 > 0)
    ...
    % back prop
    nn = nnsetup([num_inputs layer1 layer2 layer3 layer4 layer5 layer6 217]);
...
%train sae
    ...
    %back prop for PCP
    nn = nnsetup([num_inputs layer1 12 217]);
...
if(layer1 > 0 && layer2 > 0 && layer3 == 0)
    ...
    %back prop for PCP
    nn = nnsetup([num_inputs layer1 layer2 12 217]);
...
if(layer1 > 0 && layer2 > 0 && layer3 > 0 && layer4 == 0)
    ...
    %back prop for PCP
    nn = nnsetup([num_inputs layer1 layer2 layer3 12 217]);
...
if(layer1 > 0 && layer2 > 0 && layer3 > 0 && layer4 > 0 && layer5 == 0)
    ...
    %back prop for PCP
    nn = nnsetup([num_inputs layer1 layer2 layer3 layer4 12 217]);
...
if(layer1 > 0 && layer2 > 0 && layer3 > 0 && layer4 > 0 && layer5 > 0 && layer6 == 0)
    ...
    %back prop for PCP
    nn = nnsetup([num_inputs layer1 layer2 layer3 layer4 layer5 12 217]);
...
if(layer1 > 0 && layer2 > 0 && layer3 > 0 && layer4 > 0 && layer5 > 0 && layer6 > 0)
    ...
    %back prop for PCP
    nn = nnsetup([num_inputs layer1 layer2 layer3 layer4 layer5 layer6 12 217]);
