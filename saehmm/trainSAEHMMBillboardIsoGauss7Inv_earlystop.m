function [nn,inits,transitions]= trainSAEHMMBillboardIsoGauss7Inv_earlystop(ffts_train,gts_train,gts_full,layer1,layer2,layer3,layer4,layer5,layer6, multi_res, pcp_pretrain,vari,varargin)
