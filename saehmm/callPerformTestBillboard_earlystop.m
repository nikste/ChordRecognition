function [] = callPerformTestBillboard_earlystop(multi_res,pcp_pretrain,zeroMaskFrac,noisetype,vari,sparsity,sparsityPenalty,L2weightPenalty,dropout,id,shrinkfactor,layer1,layer2,layer3,layer4,layer5,layer6)
...
%sparsityPenalty = varargin{4};
    if(strcmp(noisetype,'isoGauss'))
        [nn,inits,transitions]= trainSAEHMMBillboardIsoGauss_earlystop(ffts_train,gts_train,gts_full,layer1,layer2,layer3,layer4,layer5,layer6, multi_res, pcp_pretrain,vari,zeroMaskFrac,sparsity,dropout,sparsityPenalty,L2weightPenalty);
    else
