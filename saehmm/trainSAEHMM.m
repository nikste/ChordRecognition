function [nn,inits,transitions]= trainSAEHMM(ffts_train,gts_train,gts_full,layer1,layer2,layer3,layer4,layer5,layer6, multi_res, pcp_pretrain,varargin)
...
if (multi_res == 1)
    if (pcp_pretrain == 1)
        nn = constructAE(ffts_train,gts_train,layer1,layer2,layer3,layer4,layer5,layer6,num_batch,num_train_unsup,num_train_pcp,num_train_chord,4500,sparsity,dropout,zeroMaskFrac,sparsityPenalty);
    else
        nn = constructAE(ffts_train,gts_train,layer1,layer2,layer3,layer4,layer5,layer6,num_batch,num_train_unsup,num_train_pcp,num_train_chord,4500,sparsity,dropout,zeroMaskFrac,sparsityPenalty);%constructAE(ffts_train,gts_train,200,0); %constructAE(ffts_train,gts_train,200,0);
    end
else
    if (pcp_pretrain == 1)
        nn = constructAEPCP(ffts_train,gts_train,layer1,layer2,layer3,layer4,layer5,layer6,num_batch,num_train_unsup,num_train_pcp,num_train_chord,1500,sparsity,dropout,zeroMaskFrac,sparsityPenalty);
    else
        nn = constructAE(ffts_train,gts_train,layer1,layer2,layer3,layer4,layer5,layer6,num_batch,num_train_unsup,num_train_pcp,num_train_chord,1500,sparsity,dropout,zeroMaskFrac,sparsityPenalty);
    end
end
...
function [nn] = constructAE(train_x,train_y,layer1,layer2,layer3,layer4,layer5,layer6,num_batch,num_train_unsup,num_train_pcp,num_train_chord,num_inputs,sparsity,dropout,zeroMaskFrac,sparsityPenalty)
...
function [nn] = constructAEPCP(train_x,train_y,layer1,layer2,layer3,layer4,layer5,layer6,num_batch,num_train_unsup,num_train_pcp,num_train_chord,num_inputs,sparsity,dropout,zeroMaskFrac,sparsityPenalty)
