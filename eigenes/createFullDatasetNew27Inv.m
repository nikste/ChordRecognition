function createFullDatasetNew27Inv(albumname)
...
pcpfolder = '/home/nsteen/beatles_new/data/songs2/pcp';
fftfolder = '/home/nsteen/beatles_new/data/songs2/fft';
gtfolder = '/home/nsteen/beatles_new/data/songs2/gt7Inv';

cqtfolder = '/home/nsteen/beatles_new/data/songs2/cqt';
cqtlargefolder = '/home/nsteen/beatles_new/data/songs2/cqt_large';
...
for fileindex = 1:length(wav_files)
    ...
    labfilename = labfiles{fileindex};
    %disp(labfilename);
    chordframes = createGT(labfilename,len,stepsize,11025);
    ...
    for l = 1:length(labdata)
        ...
        for j=1:3
            ...
            if(j == 3)
                %aux(j)
                %aux{j}
                aux{j} = convertTo7InvBeatles(aux{j});
